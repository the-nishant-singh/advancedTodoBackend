            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        user = _b.sent();
                        res.json({
                            token: jwt.encode((0, helpers_1.getJwtPayload)(user), AuthRoutes.JWT_SECRET),
                            user: user
                        });
                        return [3 /*break*/, 5];
                    case 4:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        res.json({ token: jwt.encode((0, helpers_1.getJwtPayload)(user), AuthRoutes.JWT_SECRET), user: user });
                        return [3 /*break*/, 4];
                    case 3:
                        error_2 = _b.sent();
                        next(error_2);
